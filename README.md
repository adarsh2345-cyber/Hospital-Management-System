...
|------------|------------|-----------|------------|--------|----------------|----------------------|------------------------|-------------------|------------|--------------------|---------------------------|
| 1          | John       | Doe       | 1990-05-14 | Male   | 1234567890     | john.doe@mail.com     | 123 Elm Street, City   | 0987654321        | O+         | ABC Insurance      | Asthma                    |
| 2          | Jane       | Smith     | 1985-09-22 | Female | 2345678901     | jane.smith@mail.com   | 456 Oak Avenue, Town   | 1234567890        | A-         | XYZ Health         | Diabetes                  |
...
|-----------|------------|-----------|----------------|----------------|--------------------|----------------------|-------------------------|------------------|
| 1         | Alice      | Johnson   | Cardiologist   | 9876543210     | alice.johnson@mail.com | 10                   | MBBS, MD (Cardiology)   | $150             |
| 2         | Bob        | Williams  | Neurologist    | 8765432109     | bob.williams@mail.com  | 8                    | MBBS, DM (Neurology)    | $120             |
...
| 2         | 2          | 1         | Heart Disease   | Blood thinners      | Aspirin            | 2024-11-21        | Stable     | 2024-12-10     |
...
|---------|------------|----------------|------------------|----------------|------------------|--------------|----------------|----------------|
| 1       | 1          | 1              | $150             | $50            | $20              | $220         | Paid           | Credit Card    |
| 2       | 2          | 2              | $120             | $100           | $40              | $260         | Pending        | Insurance      |
...
|----------|------------|-----------|-------------|----------------|----------------------|--------------|
| 1        | Sarah      | Lee       | Nurse       | 5555551234     | sarah.lee@mail.com    | 9:00 AM - 5:00 PM |
| 2        | Mike       | Clark     | Receptionist| 5555555678     | mike.clark@mail.com   | 8:00 AM - 4:00 PM |
...
|---------|---------------|-----------|--------------------|---------------|----------------|-------------|
| 1       | Ibuprofen     | Medicine  | 500                | PharmaCorp    | $0.5           | 2025-01-01  |
| 2       | ECG Machine   | Equipment | 3                  | HealthEquip   | $2000          | 2028-05-10  |
...
|------------|------------|------------------------|--------------|----------------|----------------------|
| 1          | 1          | Mary Doe               | Mother       | 0987654321     | mary.doe@mail.com    |
| 2          | 2          | Steve Smith            | Brother      | 1234567890     | steve.smith@mail.com |

---

## Conclusion

These datasets are part of the core functionalities of the **Hospital Management System**. They help in managing patient data, doctor schedules, medical records, billing, and more.
